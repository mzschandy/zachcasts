  ...
  return (
    <Row className="profile">
      <div className="image-cover d-none d-md-block">
        <img src={ImageCover} alt="Blades and Bending Logo" className="img-fluid rounded" />
      </div>
      <Col md={10} className="profile-details">
        <div className="details-wrapper">
          <img src={ImageCover} alt="Mobile Blades and Bending Logo" className="img-fluid rounded hidden d-sm-block d-md-none" />
          <div className="details-inner">
            <div className="podcast-title">Blades and Bending</div>
            <div className="podcast-date-length ">
              {episodeDate}
              {' '}
              {episodeLength}
            </div>
